\chapter[Modelli per le popolazioni di \emph{A.~mellifera}]{Modelli matematici per la descrizione delle popolazioni di \emph{Apis~mellifera}}
\label{chap:modelz}
\begin{flushright}
    \small
...
In questo capitolo discuteremo alcuni modelli proposti in letteratura per descrivere una popolazione%
\footnote{Un alveare.}
di \emph{A.~mellifera}, e le sue interazioni con patogeni e altri fattori di stress.
