...
Vediamo adesso nel dettaglio la risposta dell'alveare alle diverse forme esaminate di mortalità variabili.
...
prossima sottosezione (figg.~\ref{img:expB4} e \ref{img:expB5}).
