...
\begin{figure}[hbt]
    \centering % TODO talvolta c'è lambiente fuori la figura centrato, uniformare!
    \includegraphics[keepaspectratio,width=0.76\textwidth]{img/hillSigmoid}
...
\subsection{Modello completo api--\emph{Varroa}--ABPV}
...
Si veda in proposito la tabella~\ref{tab:kh11VSratti17} per un confronto tra le notazioni dei due modelli esaminati
nel presente capitolo.

\begin{table}[pbh]
    $$\begin{array}{ccc}
        \toprule
        \text{Khoury et al.~2011}
        & \text{Ratti et al.~2017}
        & \text{u.m.} \\
        \midrule
        H & x_h & \text{api} \\
        F & x_f & \text{api} \\
