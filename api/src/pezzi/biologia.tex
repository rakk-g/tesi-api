...
\begin{itemize}
    ...
    \footnote{Compare with Figure~\ref{img:europ}.}
...
\begin{figure}
    ...
    \caption[Distribution of \emph{A.~Mellifera} subspecies in Europe.]{Distribution of \emph{A.~Mellifera} subspecies in Europe. From Figure~``Distribuzione
    delle razze d'api in Europa'', \cite[24]{tesiFDL}.}
    \label{img:europ}
\end{figure}
